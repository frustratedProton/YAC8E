...
struct Chip8 {
  ...
  std::array<uint8_t, 65536> memory{}; // 64KB RAM FOR XO-CHIP
  ...
  // super-chip has display of 128 * 64
  ...
  // XO-CHIP stuff
  std::array<uint8_t, 128 * 64 * 2>
      display{}; // XO-CHIP have 2 superimposed bitplanes for display
  uint8_t draw_plane{1};
